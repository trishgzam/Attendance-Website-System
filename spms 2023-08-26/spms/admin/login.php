...
<head>
    ...
    <title>LOGIN | MCSI PAYROLL MANAGEMENT SYSTEM</title>
   ...
   <div class="h-100 d-flex justify-content-center align-items-center">
       <div class='w-100'>
       <main style="background-image: url('aa.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center; background-size: 100% auto;">
       <h3 class="py-5 text-center" style="color: white; font-size: 45px; text-shadow: 25px 2px 4px rgba(0, 0, 0, 0.5);" >MCSI PAYROLL MANAGEMENT SYSTEM</h3>
        <div class="card my-3 col-md-4 offset-md-4">
            <div class="card-body">
                <form action="" id="login-form">
                    <center><small>Please Log in Your Account.</small></center>
