...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> | MCSI Payroll Management System</title>
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-gradient" id="topNavBar">
        <div class="container">
        <nav class="navbar">
    <a class="navbar-brand" href="./" style="font-size: 24px; text-shadow: 2px 2px 2px black;">
      ...
      HR Management
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'home')? 'active' : '' ?> "style="color: white;" aria-current="page" href="./"><i class="fa fa-home"></i> Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'employees')? 'active' : '' ?>" style="color: black;" href="./?page=employees"><i class="fa fa-user-tie"></i> Employees</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'payroll_list')? 'active' : '' ?>" style="color: white;" href="./?page=payroll_list"><i class="fa fa-th-list"></i> Payroll</a>
                    </li>
                    <?php if($_SESSION['type'] == 1): ?>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'tax_table')? 'active' : '' ?>" style="color: black;" href="./?page=tax_table"><i class="fa fa-table"></i> Tax Table</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'admin')? 'active' : '' ?>" aria-current="page" style="color: white;" href="./?page=admin"><i class="fa fa-users"></i> Users</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: black;" href="./?page=maintenance"><i class="fa fa-cogs"></i> Maintenance</a>
                    </li>
                    <?php endif; ?>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a class="dropdown-item" style="color: red;" href="./../Actions.php?a=logout">Logout</a></li>
                </ul>
            </div>
            </div>
        </div>
